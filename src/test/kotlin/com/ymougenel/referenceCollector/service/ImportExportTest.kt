...
class ImportExportTest {
    ...
    val ref1 = Reference(0, "https://github.com/", "ref1", listOf(labels.get(0)), "user1", ReferenceType.ARTICLE)
    val ref2 = Reference(0, "https://en.wikipedia.org/wiki/Alan_Turing", "ref2", listOf(labels.get(0), labels.get(1)), "user1", ReferenceType.ARTICLE)
    val ref3 = Reference(0, "", "ref3", ArrayList(), "user2", ReferenceType.ARTICLE)
